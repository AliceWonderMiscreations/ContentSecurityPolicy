...
final class FetchDirectiveMediaSrcTest extends TestCase
{
    /**
    ...
    {
        $expected = 'default-src \'none\'; media-src *;';
        $directive = 'media-src';
        $policy = '*';
    ...
    {
        $expected = 'default-src \'self\'; media-src \'none\'; plugin-types image/svg+xml application/pdf;';
        $directive = 'media-src';
        $policy = 'none';
    ...
    {
        $expected = 'default-src \'none\'; media-src https:;';
        $directive = 'media-src';
        $policy = 'https:';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; media-src \'self\' https:;';
        $directive = 'media-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; media-src \'self\' example.org;';
        $directive = 'media-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; media-src \'self\' example.org:443;';
        $directive = 'media-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; media-src \'self\' https://example.org;';
        $directive = 'media-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; media-src \'self\' https://example.org:443;';
        $directive = 'media-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'self\' https://cdn.example.net; media-src \'self\' https://cdn.example.net https://*.elsewhere.com; plugin-types image/svg+xml application/pdf;';
        $directive = 'media-src';
