...
final class FetchDirectiveManifestSrcTest extends TestCase
{
    /**
    ...
    {
        $expected = 'default-src \'none\'; manifest-src *;';
    ...
    {
        $expected = 'default-src \'self\'; manifest-src \'none\'; plugin-types image/svg+xml application/pdf;';
        $directive = 'manifest-src';
        $policy = 'none';
    ...
    {
        $expected = 'default-src \'none\'; manifest-src https:;';
        $directive = 'manifest-src';
        $policy = 'https:';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; manifest-src \'self\' https:;';
        $directive = 'manifest-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; manifest-src \'self\' example.org;';
        $directive = 'manifest-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; manifest-src \'self\' example.org:443;';
        $directive = 'manifest-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; manifest-src \'self\' https://example.org;';
        $directive = 'manifest-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; manifest-src \'self\' https://example.org:443;';
        $directive = 'manifest-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
