...
final class FetchDirectiveImgSrcTest extends TestCase
{
    /**
    ...
    {
        $expected = 'default-src \'none\'; img-src *;';
        $directive = 'img-src';
        $policy = '*';
    ...
    {
        $expected = 'default-src \'self\'; img-src \'none\'; plugin-types image/svg+xml application/pdf;';
        $directive = 'img-src';
        $policy = 'none';
    ...
    {
        $expected = 'default-src \'none\'; img-src https:;';
        $directive = 'img-src';
        $policy = 'https:';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; img-src \'self\' https:;';
        $directive = 'img-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; img-src \'self\' example.org;';
        $directive = 'img-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; img-src \'self\' example.org:443;';
        $directive = 'img-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; img-src \'self\' https://example.org;';
        $directive = 'img-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
    ...
    {
        $expected = 'default-src \'none\'; img-src \'self\' https://example.org:443;';
        $directive = 'img-src';
        $policy = 'self';
        $csp = new \AWonderPHP\ContentSecurityPolicy\ContentSecurityPolicy('none');
        $csp->addFetchPolicy($directive, $policy);
